...
*/
 (function() {
	...
	function getTeacherList() {
		...
		let url = "https://jmrateprofessors6.herokuapp.com?mode=teacherList";
			fetch(url)
			.then(checkStatus)
	...
	function fetchTeacher() {
		...
		if (document.getElementById("selectTeacher").value == "Pick a Teacher") {
			...
			//first + "&last=" + last;
			let url = "https://jmrateprofessors6.herokuapp.com?mode=teacher&first=" + first + "&last=" + last;
			fetch(url)
			.then(checkStatus)
			.then(function(responseText) {
				let json = JSON.parse(responseText);
		...
		if ((date!=null) && (quality!=null) && (difficulty!=null) &&
		 (classN!=null) && (textbook!=null) && (takeAgain!=null) &&
		  (gradeReceived!=null)) {
			...
			let url = "https://jmrateprofessors6.herokuapp.com";
